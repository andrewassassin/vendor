<template>
	<div class="form-demo">
		...
		<div class="p-d-flex p-jc-center">
			<div class="card">
				<h5 class="p-text-center">Verify Code</h5>
				<form @submit.prevent="handleSubmit(!v$.$invalid)" class="p-fluid">
					...
					<div class="p-field">
						<div class="p-grid">
							<div class="p-col-3"><InputText style="width: 4rem"  /></div>
							<div class="p-col-3"><InputText style="width: 4rem" /></div>
							<div class="p-col-3"><InputText style="width: 4rem" /></div>
							<div class="p-col-3"><InputText style="width: 4rem" /></div>
						</div>
...
export default {
	setup() {
		...
		return { state, v$, handleSubmit, toggleDialog, submitted, countries, showMessage, date, currentRoute };
	},
};
</script>
